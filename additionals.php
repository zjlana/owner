<?php
// Main Add-ons
$additionals_addons_table_headers = array(
    "Add-ons ID",
    "Item",
    "Amount",
);

$additionals_addons_sql_query_fetch = "SELECT * FROM adds_on;";

// Guest Add-ons
$additionals_guestAddons_table_headers = array(
    "Reservation ID",
    "Guest ID",
    "Book Date",
    "Add-on ID",
...
$additionals_guestAddons_sql_query_fetch = "SELECT * FROM guest_addson;";
...
switch ($get_page_type) {
    case 'mainAddons':
        populatePage("Add-ons", "MainAddons", $additionals_addons_table_headers, $additionals_addons_sql_query_fetch);
        break;
    case 'guestAddons':
        populatePage("Guest Add-ons", "GuestAddons", $additionals_guestAddons_table_headers, $additionals_guestAddons_sql_query_fetch);
        break;
    default:
    populatePage("Add-ons", "MainAddons", $additionals_addons_table_headers, $additionals_guestAddons_sql_query_fetch);
}
